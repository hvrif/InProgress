...
- If this looks like a relapse (missed something they'd been consistent on, or their danger zone shows up in what they wrote): quote their own words back to them about who/what they do this for verbatim — "${profile.why_text}" — and ask directly whether that's still true right now.
